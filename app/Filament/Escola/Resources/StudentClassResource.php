...
class StudentClassResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ...
            ->when(static::currentTenantId(), fn (Builder $query, int $institutionId): Builder => $query->where('institution_id', $institutionId));
    }
                ...
                ->schema([
                    Forms\Components\Select::make('academic_year_id')
                        ...
                        ->afterStateUpdated(function (Set $set): void {
                            $set('institution_id', static::currentTenantId());
                    ...
                    Forms\Components\Hidden::make('institution_id')
                        ->default(fn (): ?int => static::currentTenantId()),
    ...
    {
        $data['institution_id'] = static::currentTenantId() ?: ($data['institution_id'] ?? null);
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('course')
                    ...
                    ->options(fn (): array => Course::query()
                        ->whereIn('id', CourseMap::query()
                            ->where('institution_id', static::currentTenantId())
                            ->where('is_active', true)
                            ->select('course_id'))
                        ->orderBy('name')
                        ->pluck('name', 'id')

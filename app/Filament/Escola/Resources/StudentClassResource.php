...
class StudentClassResource extends Resource
{
    ...
    {
        $query = parent::getEloquentQuery()->with(['courseMap', 'courseMap.course', 'courseMap.institution', 'courseMap.academicYear', 'academicYear', 'institution']);
                ...
                Forms\Components\Select::make('course_map_id')
                    ...
                    ->options(function () {
                        ...
                        return \App\Models\CourseMap::with(['course', 'institution', 'academicYear'])
                            ...
                            ->when($tenant, fn($q) => $q->where('institution_id', $tenant->id))
                            ->get()
                            ->mapWithKeys(fn($map) => [
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('course')
                    ...
                    ->query(
                        fn(\Illuminate\Database\Eloquent\Builder $query, array $data) =>
                        $query->when(
                            $data['value'],
                            fn($q, $v) =>
            ...
            ->headerActions([
                \Filament\Actions\CreateAction::make()
                    ...
                    ->mutateFormDataUsing(function (array $data): array {
                        $tenant = \Filament\Facades\Filament::getTenant();
                        if ($tenant && empty($data['institution_id'])) {

...
class EffectiveListsSheet implements FromArray, WithTitle, WithHeadings, WithStyles
{
    ...
    {
        $types = array_values(Effective::staffTypeOptions());
        ...
        $bloodTypes = array_keys(Effective::bloodTypeOptions());
        $countries = [
            'Angola',
            'Brasil',
            'Cabo Verde',

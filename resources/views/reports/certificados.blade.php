...
@section('title', 'Relatório de Certificados')
@section('filters')
...
<table>
    ...
    <tbody>
        ...
        @php
        $institutionId = isset($institution) ? $institution->id : null;
        // Filter evaluations by institution if set
        $evals = $institutionId
        ? $r->evaluations->where('institution_id', $institutionId)
        : $r->evaluations;

        // Calculate subject averages using proper formula (NPP*40% + Exame*60%)

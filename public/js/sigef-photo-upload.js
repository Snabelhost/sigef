(function () {
    ...
    const cameraIcon =
        '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8.75 5.5a1 1 0 0 0-.8.4l-1 1.35H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-1.95l-1-1.35a1 1 0 0 0-.8-.4h-6.5Zm3.25 3.25a4.25 4.25 0 1 1 0 8.5a4.25 4.25 0 0 1 0-8.5Zm0 1.5a2.75 2.75 0 1 0 0 5.5a2.75 2.75 0 0 0 0-5.5Z"/></svg>';
    const uploadIcon =
